...
<!-- 										<input type="text"  name="cm_name" placeholder="이름을 입력하세요" style="width:100%"> -->
											<input type="text" name="id" readonly value="${id }" style="width:100%; border:0 solid black; " id = "id";>
										</td>
									</tr>
									<tr>
										<th>연락처</th>
...
<!-- 											</div> -->
											<input type="text" name="phone" readonly value="${reservDTO.phone }"  style="width:100%; border:0 solid black;" id = "phone";>
										</td>
									</tr>
									<tr>
										<th>예약일자</th>
