	...
	<section id="container">
		...
		<div class="content">
			<div class="member_wrap">
				<h1 onCLIck="document.location.href='/';"><span class="hide">HM SPORTS</span></h1>

				<form name="frmJoin" method="post" action="join_form_ok.asp" >
				<div class="join_wrap info">
					<dl>
						...
						<dd>
							<input type="password"  name="pwd1" style="width:100%" />
						...
						<dd>
							<div class="auth_wrap">
								<input type="text" id="sms_cnfm" title="" name="sms_cnfm" placeholder="수신번호 입력"/> 
...
function checkForm(){
	...
	if (EmptyChk(frm.pwd.value) < 4) {
		alert("[비밀번호]는 4이상 입력되어야 합니다.");
		frm.pwd.focus();
		return;
	}
	if (EmptyChk(frm.pwd1.value) < 4) {
		alert("[비밀번호]는 4이상 입력되어야 합니다.");
		frm.pwd1.focus();
		return;
	}
