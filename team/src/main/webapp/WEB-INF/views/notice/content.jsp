...
onclick="location.href='${pageContext.request.contextPath}/notice/update?num=${boardDTO.num}'">
<input type="button" value="글삭제" 
onclick="location.href=='${pageContext.request.contextPath}/notice/delete?num=${boardDTO.num}'">
