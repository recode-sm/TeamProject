...
<div id="wrapper"> 
	...
	<section id="container">
		<!-- Contents -->
		<form name=frmLogin class="signUp" id="signupForm" action="<%=request.getContextPath() %>/member/loginPro" method="post">
				...
				<div class="member_wrap">
					...
					<div class="login_wrap">
						<dl>
							...
							<!-- input태그 name이 달라서 각각 id, name으로 수정함  -->
						...
						<span class="chk"><input type="checkbox" name="id_mem" checked id="idsave"><label for="idsave">아이디 저장</label></span>
							...
							<input type="button" value="회원가입"  class="btn_middle" onclick="location.href='<%=request.getContextPath() %>/member/insert'">
						</div>
					</div>
				</div>
			</div>
